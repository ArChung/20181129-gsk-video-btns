+function ($) {
    ...
    PopVideo.DEFAULTS = {
        ...
        closeOnEnd: false,
        pauseOnClose: true,
        closeKey: 'esc', //(String || Boolean) �虾�匧�� any嚗靕alse,esc���嗡�硋�潮�䁅恕銝榷sc
        title: '',
        video: '',//(String || Array)
        duration: 300,
        callback: {
    ...
    PopVideo.prototype.init = function (element, options) {
        ...
        //敶枏���㺭�旿嚗��𥪜���颲函���峕𧒄�鵭嚗㕑◤��㰘蝸�𧒄餈鞱�𣬚��𡁏𧋦��
...
// 憯圈𨺗�綉��
    ...
    function requestFullScreen(element) {
        ...
        var requestMethod = element.requestFullScreen || //W3C
            element.webkitRequestFullScreen ||    //Chrome蝑�
    ...
    function exitFull() {
        ...
        var exitMethod = document.exitFullscreen || //W3C
            document.mozCancelFullScreen ||    //Chrome蝑�
